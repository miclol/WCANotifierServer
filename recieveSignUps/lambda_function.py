...
def lambda_handler(event, context):
    ...
    if httpSource["path"] == "/":
        ...
        if httpSource["method"] == "POST":
            ...
            client("sesv2").send_email(Destination={"ToAddresses": [email]}, Content={"Simple": {"Body": {"Html": {"Data": content}}, "Subject": {"Data": "WCA Notifier Verification Email"}, "Headers": [{"Name": "List-Unsubscribe", "Value": f"<https://m4q4s5pxsarghztkazrode4mdq0dtfli.lambda-url.us-east-2.on.aws/?uuid={uuid}>"}, {"Name": "List-Unsubscribe-Post", "Value": "List-Unsubscribe=One-Click"}]}}, FromEmailAddress="WCA Notifier <updates@wcanotifier.com>")
