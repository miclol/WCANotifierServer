...
def lambda_handler(event, context):
    try:
        ...
        ses.send_email(Destination={"ToAddresses": ["wcaalert@gmail.com"]}, Content={"Simple": {"Body": {"Text": {"Data": format_exc()}}, "Subject": {"Data": "WCA Notification Failed!"}}}, FromEmailAddress="wcaalert@gmail.com")